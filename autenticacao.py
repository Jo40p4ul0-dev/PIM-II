...
import bcrypt
from InquirerPy import inquirer##biblioteca de seta
from InquirerPy.validator import EmptyInputValidator##biblioteca de validaçao "vazio"
from rich.panel import Panel##cores
